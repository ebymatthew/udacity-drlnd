...
In this project, agents are trained to play each in the multi-agent [Tennis](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#tennis) environment.
...
1. Place the file in the DRLND GitHub repository, in the this folder, and unzip (or decompress) the file. 

### Instructions

In order to train an agent run (passing the unzipped os-specific environment you downloaded to the `--env` variable):

    python train.py --env Tennis.app --episodes 3000
    
In order to watch the trained agents play run:

    python run.py --env Tennis.app --episodes 3000
